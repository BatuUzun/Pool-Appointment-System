...
public class LifeguardLogInFrame extends JFrame {
	...
	private ImageIcon poolPng = new ImageIcon("images/lifeguard.jpg");
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LifeguardLogInFrame frame = new LifeguardLogInFrame();
	...
	public LifeguardLogInFrame() {
		...
		JLabel lblNewLabel_2 = new JLabel("***Password is your certification no***");
		lblNewLabel_2.setBounds(10, 56, 412, 14);
		...
		okBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(((Lifeguard)(searchedUser)).getCertificationNumber().equalsIgnoreCase(String.valueOf(passwordField.getPassword()))) {
		...
		contButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(searchedUser == null || !(searchedUser instanceof Lifeguard)) {
