...
public class GeneralManagerLogInFrame extends JFrame {
		...
		private ImageIcon poolPng = new ImageIcon("images/generalmanager.jpg");
		/**
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						GeneralManagerLogInFrame frame = new GeneralManagerLogInFrame();
		 ...
		 * Create the frame.
		 */
		public GeneralManagerLogInFrame() {
			setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			setBounds(100, 100, 466, 688);
			...
			JLabel lblNewLabel_2 = new JLabel("*Password is 'first three letter of your surname+first three letter of your TC no'*");
			lblNewLabel_2.setBounds(0, 56, 450, 14);
			...
			okBtn.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(String.valueOf(passwordField.getPassword()).equals(searchedUser.getSurname().substring(0, 3)+searchedUser.getTcNo().substring(0, 3))) {
						GeneralManagerScreenFrame generalManagerScreenFrame = new GeneralManagerScreenFrame(searchedUser);
						generalManagerScreenFrame.setVisible(true);
			...
			contButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(searchedUser == null || !(searchedUser instanceof GeneralManager)) {
